    ...
    p_data : {
        ...
        home_top : {
            ...
            contents : '한국문화예술교육진흥원은 "유니트윈-문화다양성과 지속가능발전을 위한 예술교육 연구회"의 정회원으로서 예술교육의 성찰과 미래를 모색하기 위한 정기 학술대회를 개최합니다.\n\n'
                        +'제4회 유니트윈 학술대회는 "위기의 시대, 행동하는 예술교육"을 주제로 하여 예술교육의 원리와 사례가 어떻게 오늘날의 세계가 마주한 사회적‧문화적 위기에 대해 심도 있게 기여할 수 있는지 논하려 합니다.',
        ...
        home_day2 : {
            ...
            session1 : {
                text1 : '기조발제 1',
                text2 : '13:00-13:40',
                text3 : '문화예술교육 2.0에서의 다양성',
                text4 : '에른스트 바그너 ',
                text5 : '(Ernst Wagner)',
                text6 : '- 유니트윈-문화다양성과 지속가능발전을 위한 예술교육 연구회 명예회원 / 뮌헨 미술원 선임연구원, 독일',
                text7 : '[모더레이터]',
                text8 : '치후 럼 ',
                text9 : '(Chee-Hoo Lum)',
            ...
            session4 : {
                ...
                text15 : '주의력 또는 과잉 활동 장애가 있는 4-8학년 학생을 위한\n정서적 자기 조절을 촉진하기 위한 예술: 여러 사례 연구',
                text16 : '야라 도크래트 ',
                text17 : '(Yaara Docrat)',
                text18 : '- 퀸즈 대학교 석사과정생, 캐나다',
                text19 : '[모더레이터]',
                text20 : '네릴 지네렛 ',
            ...
            session5 : {
                ...
                text18 : '시각예술교육: 지연의 연속과 불확실한 시간 속에서 세계를\n이어주고, 풀어주고, 지속하며 완화해주는 국제적 맥락',
                text19 : '캐스린 콜먼 ',
        ...
        home_day3 : {
            ...
            session2 : {
                ...
                text2 : '교실 속의 예술',
                text3 : '13:40-15:10',
                text4 : "COVID-19 대유행 기간 동안 케냐 대학 학생들의\n석방, 구호, 성찰 및 복원을 촉진하기 위한 미술 치료 사용",
                text5 : '메리 클레어 키덴다 ',
                text6 : '(Mary Clare Kidenda)',
                text7 : '- 케냐 공과대학교 학과장, 케냐',
                text8 : '포용적 관행을 위한 인형극의 마술 같은 힘',
                text9 : '에밀리 맥밀런 ',
                text10 : '(Emily MacMillan)',
                text11 : '- 퀸즈 대학교 석사과정생, 캐나다',
                text12 : '교실에서 다양성과 문화적 표현의 필요성: 실용적인 전략과 그 실행',
                text13 : '홍지혜',
                text14 : '- 브리검 영 대학교 부교수, 미국',
                text15 : '2020년 학생들의 목소리를 사용한 디지털 예술과 협작',
                text16 : '에밀리 윌슨 ',
                text17 : '(Emily Wilson)',
            ...
            session3 : {
                ...
                text2 : '예술 참여',
                text3 : '15:10-16:40',
                text4 : '팬더믹 이후의 온라인 문화예술교육은 어떻게 예술교육가의 정체성을 재구성하는가',
                text5 : '제환정',
                ...
                text12 : '서비스 학습의 네러티브: 난양 미술 아카데미 사례 연구',
                text13 : '레베카 칸 ',
                text14 : '(Rebecca Kan)',
            ...
            session4 : {
                ...
                text2 : '다양성 & 문화적 묘사',
                text3 : '15:10-16:40',
                text4 : '위기의 시기 속의 예술: 불평등 사례',
                text5 : '루스 렌츠러 ',
                text6 : '(Ruth Rentschler)',
                text7 : '- 사우스오스트레일리아대학교 교수, 호주',
                text8 : 'LGBTQ 역사 사례를 만드는 박물관들',
                text9 : '심지영',
                ...
                text16 : '침묵의 단계: 캐나다 엘 시스테마(El Sistema)가 코로나에 응답하다',
                text17 : '숀 코르코란 ',
                text18 : '(Sean Corcoran)',
                text19 : '- 퀸즈대학교 박사과정생, 캐나다',
                text20 : '벤저민 볼든 ',
                text21 : '(Benjamin Bolden)',
                text22 : '- 퀸즈대학교 부교수, 캐나다',
                text23 : '[모더레이터]',
                text24 : '치후 럼 ',
                text25 : '(Chee-Hoo Lum)',
            ...
            session5 : {
                ...
                text2 : '현장사례연구 2',
                text3 : '16:40-18:25',
                text4 : '포용적 문화예술교육의 실천 : 책누나프로젝트의 기후위기 수업사례를 중심으로',
                text5 : '장수혜',
                ...
                list : [
                    {
                        ...
                        li_contents : '서울 어젠다 채택 이후로 10년이 넘는 기간 동안, 전 세계의 예술교육에 대한 가장 중요한 문서를 다시 살펴볼 때다. 서울 어젠다는 큰 성공을 거뒀고 그 이후로 많은 것이 성취되었다. 서울 어젠다가 유니트윈같은 네트워크에 국제적으로 집중된 협력을 촉발한 것을 예로 들 수 있다.\n\n'
                                    +'그러나, 2017년에 벤저민 볼든과 다른 사람들이 함께 발간한 전 세계 예술교육의 이해도에 대한 비교 연구(국제예술교육연보, V5, 2017)에선 서울 어젠다의 목표에 대한 세계적인 공감 하에 현저하게 다르고, 또 다양한 형태가 존재하고 있음을 보여준다.\n\n'
                                    +'에른스트 바그너의 강의는 이러한 다양성이 새롭게 보여질 필요가 있다는 것을 보여주기 위해 "시각적 문화의 탐구"를 예시로 사용할 것이다. 바그너는 이견에 대해서 추가적인 심사숙고가 절대적으로 필요하다는 것을 보여줄 것이다. 그래야만 서울 어젠다의 3번째 목표인, "문화 다양성 증진과 문화적 대화"가 실행될 수 있다. 전 세계적으로 정치적, 그리고 문화적 긴장감이 고조되는 시대에, 오로지 예술교육만이 문화적 다양성을 심각하게 받아들이고, 전 세계의 이해당사자들을 진정한 대화에 끌어들임으로써 "문화적 문제의 해결"에 도움이 될 수 있다. 이 프레젠테이션에서는 이 방법이 어떻게 작용되는지에 대한 원칙이 제시될 것이다.'
                    },
                    {
                ...
                list : [
                    {
                        ...
                        li_contents : '베냐민 외리센은 문화와 미학에 초점을 맞춘 교육 의장, 그리고 프리드리히-알렉산더-대학교 에를랑겐-뉘른베르크에서 유네스코 교육 예술 문화 의장직을 맡고 있다. 또한 베냐민은 유럽 과학 예술 아카데미와 독일 예술 문화 교육 협회의 회원이다. 그의 연구는 특히 유네스코와 관련된 문제들과 포스트 디지털 문화에서의 교육의 변혁과 관련하여, 교육 이론과 문화, 예술, 미학 교육에 대한 경험적 연구에 초점을 맞추고 있다.\n\n'
                                     +'베냐민은 독일 연방교육연구부의 자금 지원을 받는 메타 프로젝트 "예술과 문화 교육의 디지털화"와 같은 예술 교육의 디지털화에 관한 몇 가지 주요 경험적 연구에 기반한 프로젝트를 이끌고 있다. 최근 출판된 책과 및 향후 출판될 책은 다음과 같다: 외리센 『변환 스펙트럼: 예술교육연구와 문화역학(2018)』. 왁스만, 외리센/크뢰너/언터버그 『문화교육의 디지털화에 관한 연구(2019)』. 외리센/언터버그/클레파키: 『변혁의 미학. 예술교육연구와 문화적 지속가능성의 도전』'
                    },
                    {
                        img : session_img_43,
                        moder : '[모더레이터]',
                        ...
                        li_contents : '탄야 클레패키 박사는 독일 에를랑겐의 뉘른베르크의 프리드리히-알렉산더 대학교에 유네스코 교육문화 의장 선임 연구원이다. 그 중에서도 그녀는 뉘른베르크에 있는 학교 연극 및 공연 교육 학회의 전무이사를 맡고 있다. 그녀의 업무 분야는 문화 및 미학 교육의 영역에서 이론 및 실증 연구다. 2020년 12월 이후, 그녀는 또한 새로 설립된 상호 심사, 오픈 액세스 "문화, 미학, 예술 교육 분야의 국제 연구 저널"을 이끌고 있다.'
                    }
                ]
            }  
        },
        ...
        session_detail : {
                        ...
                        li_data : [
                            {
                                ...
                                contents : "사냐 크르스마노비츠 타시치는 연극 감독, 안무가, 여배우, 드라마, 무용 교육자이다. 또 세르비아의 중등교육 기관에 최초의 무대장치 예술 및 멀티미디어 수업의 커리큘럼을 집필하는 전문가 실무 그룹의 멤버이며, 세르비아의 CEDEUM의 회장이자 예술 유토피아, 그리고 '마터 테라'의 어린이들과 청소년들의 축제 예술 감독, 그리고 드라마/극장 교육 및 공연 예술에 대한 에세이, 리뷰 및 기사 집필자다. 사냐는 수많은 프로그램 및 프로젝트의 저자이자 제작자이며, 두 분야 모두 교육적이면서도 예술적이다. 사냐는"
                                          +'작품 "영혼의 생태학"으로는 예술과 예술교육을, 그리고 최초의 참여형 교육연극(Theatre in Education) 뮤지컬인 "움직임에 담긴 에세이"와 사이버 따돌림을 다룬 "돌의 말"처럼 작품에 대한 획기적인 개념과 방법론을 개발해오고 있다. 또한 그녀의 연극 그룹인 '
                                          +"'헬렙 티타(Hleb Teatar)'와 함께, 사냐는 국제적인 공연을 제작하고 순회하며, 연극교육의 혁신적인 형태를 개발하였다.\n\n"
                                          +'사냐는 춤과 연구실, 극장에서의 경험을 드라마/극장 교육의 독창적인 전체론적 접근법과 방법론으로 혼합한 워크숍과 마스터 클래스를 진행해왔다. 또 2009년부터 2010년까지 세르비아 DICE(Drama Improves Key Lisbon Competences) 연구팀의 일원으로 활동했다. 사냐는 2020년 5월 유네스코 국제 예술 교육 주간 행사의 일환으로 "예술 교육을 위한 종"이라는 광범위한 국제 운동을 시작했다.',
                                download : true,
                        ...
                        li_data : [
                            {
                                ...
                                name : '엠시 베트만 ',
                                enname : '(MC Bettman)',
                                job : '- 남아프리카 대학교 조교수, 남아프리카',
                                contents : '엠시 베트만은 남아프리카 대학교 영어학부의 조교수이며, 2020년에 남아프리카 대학교에서 교육학 박사학위를 취득했다. 베트만 박사의 논문 제목은 "남아프리카 초등학교 교육 및 학습 생활 오리엔테이션에서 성과적인 교육학으로서의 포럼 극장"이다. 베트만 박사는 네덜란드 위트레흐트 대학교에서 두 개의 석사학위를 받았는데, 남아프리카 연극에 관한 주제로 영어영문학(English language and literature/1988년)과 연극과학학(Theatre Science/1989년)에서 취득했다.\n\n'
                                           +'그녀의 전문 연구 분야는 보알(Boal)의 포럼 극장을 학교 맥락에서 적용하여 드라마를 통해 학습자들에게 삶의 기술을 가르치는 것이다. 미국 NADTA 요세미티 회의(2014년)와 호주 시드니 게임 체인저 콘퍼런스(2015년)에서 그녀는 두 개의 포럼 극장 워크숍을 국제 학술 관객들에게 선보였다. 박사학위 연구의 일환으로 마리에타의 사례 연구는 2016년 남아프리카의 한 초등학교에서 실행되었다. 또한 2016년 남아프리카 대학교에서 열린 2년 단위 부서별 타임 콘퍼런스에서 베트만 박사는 학교에서 포럼 극장을 적용하는 것에 대한 기간의 측면을 논문으로 발표했다.\n\n'
            ...
            c : {
                ...
                list : [
                        ...
                        li_data : [
                            {
                                ...
                                contents : '난 장은 중국 베이징 무용 아카데미에서 학사 및 석사학위를 마쳤다. 현재, 그녀는 호주 모내시 대학교 교육학부의 박사 후보생이며, 연구 관심사는 춤과 언어 교육, 콘텐츠 및 언어 통합 학습, 다문화주의, 사회적 다양성, 형평성 등이다.\n\n'
                                          +'사회적 다양성과 형평성과 깊은 관련이 있는 다양한 언어의 유지관리, 학습, 습득은 호주와 같은 다문화 사회에서 점점 더 중요하다. 불행히도, 세대가 교체되면서 많은 이민자 및 또는 아이들이 그들의 유산, 문화적, 또는 상호 문화적인 이해를 얻을 수 있도록 돕는 제2외국어 프로그램들이 증가하고 있으며, 이러한 증가는 사회적 다양성과 형평성에 더 부정적인 영향을 미칠 수 있다.\n\n'
                    ...
                    {
                        moder : '',
                        li_title : "주의력과 / 또는 과잉 활동 장애가 있는 4-8 학년 학생을 위한 정서적 자기 조절을 촉진하기 위한 예술: 여러 사례 연구",
                        li_data : [
                            {
                                imgs : session_img_14,
                                name : '야라 도크래트 ',
                                enname : '(Yaara Docrat)',
                                job : '- 퀸즈 대학교 석사과정생 , 캐나다',
            ...
            d : {
                ...
                list : [
                    ...
                    {
                        moder : '',
                        li_title : "시각예술교육: 지연의 연속과 불확실한 시간 속에서 세계를 이어주고, 풀어주고, 지속하며 완화해주는 국제적 맥락",
                        li_data : [
                            {
                                imgs : session_img_19,
                                name : '캐스린 콜먼 ',
                                ...
                                job : '- 맬버른 대학교 부교수, 호주',
                                contents : '캐스린 콜먼 박사는 예술, 디지털 공간, 연습, 문화의 교차점에 관심을 둔다. 콜먼 박사의 방식은 교사 실습, 정체성의 실천, 그리고 연습으로서의 지식을 통해 알게 된다.',
                                download : true,
            ...
            e : {
                ...
                list : [
                    {
                        moder : '',
                        li_title : "COVID-19 대유행 기간 동안 케냐 대학 학생들의 석방, 구호, 성찰 및 복원을 촉진하기 위한 미술 치료 사용",
                        li_data : [
                            {
                                imgs : session_img_22,
                                name : '메리 클레어 키덴다 ',
            ...
            h : {
                ...
                list : [
                    {
                        moder : '',
                        li_title : "포용적 문화예술교육의 실천: 책누나프로젝트의 기후위기 수업사례를 중심으로",
                        li_data : [
                            {
                                imgs : session_img_36,
                                name : '장수혜',
        ...
        closing : {
            ...
            list : [
                ...
                },
                {
                    ...
                    li_contents : '케냐 출신의 에밀리 아치엥 아쿠노 교수는 음악 연주자이자 교육자로 케냐, 미국, 영국에서 교육받았다. 그녀는 케냐와 남아프리카에서 음악교육을 통해 문화적 관련성에 중점을 둔 연구를 수행했다. 현재 진행 중인 그녀의 연구는 케냐의 국립연구기금이 후원하는 프로젝트인 지역사회 발전을 위한 청년들에게 힘을 실어주기 위한 수단으로서의 창의성에 대한 연구다.\n\n'
        ...
        footer : {
            ftaddress : '제4회 유네스코 유니트윈 학술대회 운영사무국 (주)프럼에이 (105-87-52236)\n서울 마포구 성미산로23길 30-5',
    ...
    m_data : {
        ...
        home_day1 : {
            ...
            session8 : {
                ...
                text3 : '<지금, 기후위기-문화예술교육을 통해 바라본 기후위기>',
                text4 : '박신의',
                text5 : '- 제4회 유네스코 유니트윈 국제\n학술대회 조직위원장 / 경희대학교 교수, 대한민국',
                text6 : '성지수',
                text7 : '- 콜렉티브 뒹굴 대표, 대한민국',
                text8 : '',
                text9 : '',
                text10 : '모상미',
                text11 : '- 부산 모이다아트협동조합 대표,\n대한민국',
                text12 : '강진숙',
                text13 : '- 광명업사이클아트센터 대표, 대한민국',
                text14 : '박진희',
                text15 : '- 상상창고 숨 대표 / 제주문화예술재단 창의예술교육랩장, 대한민국',
        ...
        home_day2 : {
            ...
            session3 : {
                ...
                text10 : '(Sanja Krsmanovic Tasic)',
                text11 : '- 국제연극교육협회(IDEA) 이사장, 세르비아',
                text12 : '6학년 크리에이티브 아트 교실에서 생활\n기술을 개발하기 위한 수행 교육',
                text13 : '엠시 베트만 ',
                text14 : '(MC Bettman)',
                text15 : '- 남아프리카 대학교 조교수, 남아프리카',
                text16 : '팬데믹 시대의 심리적 문제와 정신건강의\n대응방안으로써의 문화예술치유',
                text17 : '김채연',
                text18 : '- (사)한국임상미술치료협회 회장, 대한민국',
                text19 : '[모더레이터]',
                text20 : '글로리아 자파타 ',
                text21 : '(Gloria P. Zapata)',
                text22 : '- 후안 코르파스 대학재단 및 보고타 대학교\n유네스코 체어, 콜롬비아',
                link : '/unitwin2021/session/2'
            },
            session4 : {
                text1 : '세션 3',
                ...
                text13 : '(Nan Zhang)',
                text14 : '- 모내시 대학교 박사과정생, 중국',
                text15 : '주의력 또는 과잉 활동 장애가 있는 4-8학년 학생을 위한 정서적 자기 조절을 촉진하기 위한 예술: 여러 사례 연구',
                text16 : '야라 도크래트 ',
                text17 : '(Yaara Docrat)',
                text18 : '- 퀸즈 대학교 석사과정생, 캐나다',
                text19 : '[모더레이터]',
            ...
            session5 : {
                ...
                text16 : '(Zen Teh)',
                text17 : '- 환경 예술가 및 교육자, 싱가포르',
                text18 : '시각예술교육: 지연의 연속과 불확실한 시간 속에서 세계를 이어주고, 풀어주고, 지속하며 완화해주는 국제적 맥락',
                text19 : '캐스린 콜먼 ',
                text20 : '(Kathryn Coleman)',
                text21 : '- 맬버른 대학교 부교수, 호주',
                text22 : '마크 셀크리그 ',
        ...
        home_day3 : {
            ...
            session1 : {
                ...
                text4 : '베냐민 외리센 ',
                text5 : '(Benjamin Jorissen)',
                text6 : '- 유니트윈-문화다양성과 지속발전가능한 예술교육 연구 프로그램 정회원, 유니트윈-문화다양성과 지속가능발전을 위한 예술교육 연구회 정회원 / 프리드리히 알렉산더 에를랑겐-뉘른베르크 대학교\n유네스코 문화예술교육 체어 의장, 독일',
                text7 : '[모더레이터]',
                text8 : '탄야 클레패키 ',
                text9 : '(Tanja Klepacki)',
                text10 : '- 프리드리히 알렉산더 에를랑겐-뉘른베르크\n대학교 유네스코 문화예술교육 체어 선임 연구원, 독일',
                link : '/unitwin2021/plenary-session/2'
            },
            session2 : {
                text1 : '세션 5',
                text2 : '교실 속의 예술',
                text3 : '13:40-15:10',
                text4 : "COVID-19 대유행 기간 동안 케냐 대학 학생들의 석방, 구호, 성찰 및 복원을 촉진하기 위한 미술 치료 사용",
                text5 : '메리 클레어 키덴다 ',
                text6 : '(Mary Clare Kidenda)',
                text7 : '- 케냐 공과대학교 학과장, 케냐',
                text8 : '포용적 관행을 위한 인형극의 마술 같은 힘',
            ...
            session4 : {
                ...
                text9 : '심지영',
                text10 : '- 홍익대학교 조교수, 대한민국',
                text11 : '남한 청소년과 탈북 청소년의 공존을 위한 지역사회 기반 미술 프로젝트의 현상학적\n연구',
                text12 : '김유리',
                text13 : '- 이화여자대학교 박사과정생, 대한민국',
                text14 : '박소정',
                text15 : '- 이화여자대학교 조교수, 대한민국',
                text16 : '침묵의 단계: 캐나다 엘 시스테마\n(El Sistema)가 코로나에 응답하다',
                text17 : '숀 코르코란 ',
                text18 : '(Sean Corcoran)',
                text19 : '- 퀸즈대학교 박사과정생, 캐나다',
                text20 : '벤저민 볼든 ',
            ...
            session5 : {
                ...
                text11 : '이현정',
                text12 : '- 지아정원 대표 / 이화여자대학교 박사과정생, 대한민국',
                text13 : '위기 속에서 탄생한 새로운 예술교육 장르\n소개',
                text14 : '배성종',
                text15 : '- 예술 강사, 대한민국',
                text16 : '과도기를 이어주다: 예술교육이 성인으로\n가기 전의 아이들을 어떻게 이끌어 주는가',
                text17 : '최영희',
                text18 : '- 한국문화예술교육진흥원 미래교육팀 팀장,\n대한민국',
                text19 : '[모더레이터]',
                text20 : '홍유진',
                text21 : '- 한국문화예술교육진흥원 교육기반본부 본부장, 대한민국',
                link : '/unitwin2021/session/8'
                ...
                list : [
                    {
                        ...
                        name : '에른스트 바그너 ',
                        en_name : '(Ernst Wagner)',
                        li_title : '- 유니트윈-문화다양성과 지속가능발전을 위한 예술교육\n연구회 명예회원 / 뮌헨 미술원 선임연구원, 독일',
                        li_contents : '서울 어젠다 채택 이후로 10년이 넘는 기간 동안, 전 세계의 예술교육에 대한 가장 중요한 문서를 다시 살펴볼 때다. 서울 어젠다는 큰 성공을 거뒀고 그 이후로 많은 것이 성취되었다. 서울 어젠다가 유니트윈같은 네트워크에 국제적으로 집중된 협력을 촉발한 것을 예로 들 수 있다.\n\n'
                                    +'그러나, 2017년에 벤저민 볼든과 다른 사람들이 함께 발간한 전 세계 예술교육의 이해도에 대한 비교 연구(국제예술교육연보, V5, 2017)에선 서울 어젠다의 목표에 대한 세계적인 공감 하에 현저하게 다르고, 또 다양한 형태가 존재하고 있음을 보여준다.\n\n'
                                    +'에른스트 바그너의 강의는 이러한 다양성이 새롭게 보여질 필요가 있다는 것을 보여주기 위해 "시각적 문화의 탐구"를 예시로 사용할 것이다. 바그너는 이견에 대해서 추가적인 심사숙고가 절대적으로 필요하다는 것을 보여줄 것이다. 그래야만 서울 어젠다의 3번째 목표인, "문화 다양성 증진과 문화적 대화"가 실행될 수 있다. 전 세계적으로 정치적, 그리고 문화적 긴장감이 고조되는 시대에, 오로지 예술교육만이 문화적 다양성을 심각하게 받아들이고, 전 세계의 이해당사자들을 진정한 대화에 끌어들임으로써 "문화적 문제의 해결"에 도움이 될 수 있다. 이 프레젠테이션에서는 이 방법이 어떻게 작용되는지에 대한 원칙이 제시될 것이다.'
                    },
        ...
        footer : {
            ftaddress : '세계문화예술교육 주간 운영사무국 (주)프럼에이 (105-87-52236)\n서울 마포구 성미산로23길 30-5',
            fttel : '대표전화 | 02-733-1399',
            activetime : '운영시간 | 월-금 10:00 - 19:00 (주말, 공휴일 휴무)',
            ftlogo_1 : mlogo1,
            ftlogo_1_alt : '문화체육관광부',
